...
namespace MyMediaLite.Data
{
	...
	///
	[Serializable()]
	public class StackableRatings : DataSet, IRatings
	{
		///
		...
		///
		public StackableRatings(SerializationInfo info, StreamingContext context) : base(info, context)
		{
